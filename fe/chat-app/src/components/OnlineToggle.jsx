...
const StyledWrapper = styled.div`
  ...
  .container  input:checked + .button {
    ...
    border: 4px solid rgba(0, 200, 80, 0.281);
  ...
  @keyframes animeFill {
    to {
      fill: rgba(0, 200, 80, 0.642);
    }
  }

  @keyframes animeBorder {
    to {
      border-color: rgba(0, 200, 80, 0.137);
    }
  }`;
